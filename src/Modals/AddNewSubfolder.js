...
import { createPage, createSubFolder } from '../features/notesSlice';

export default function AddNewItem({ showModal, setShowModal, folderPos }) {
    let [isOpen, setIsOpen] = useState(true)
    console.log("folderPis")
    ...
    const onSubmit = submitData => {
        ...
        dispatch(createSubFolder({ ...submitData, folderPos: folderPos }))
        closeModal();
